...
const userSpec = {
  ...
  info: {
    ...
    description: [
      ...
      "",
      "### Email (OTP)",
      "Verification and password-reset OTPs use **ZeptoMail API** first, then **Zoho SMTP**, then **ZeptoMail SMTP**. Email failures are logged server-side and do not block API responses.",
      "",
      "### Response shape",
